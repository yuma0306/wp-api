 ...
 */
// ページのパス一覧を取得
export const getStaticPaths = getTemplatePaths('page-lp-alexa.php');
// パス一覧から現在のURLに一致するpostを取得
export const getStaticProps = getTemplateProps('page-lp-alexa.php');
/**
 * Export default
 */
export default function Article({ post }: { post: PostType }) {
  ...
  return (
    <>
      ...
      <HeadingLv1 addClass="HeadingLv1--alexa">{post.title.rendered}</HeadingLv1>
